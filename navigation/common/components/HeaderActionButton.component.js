...
const HeaderActionButtonComponent = props => {
  ...
  return (
    <>
      <TouchableOpacity activeOpacity={0.7} onPress={props.type === "home" ? setModalOpen : props.onClick}>
        {props.type === "drawer" ? DrawerButtonIcon : props.type === "back" ? BackButtonIcon : props.type === "home" ? HomeButtonIcon : undefined}
      </TouchableOpacity>
      <ConfirmModalComponent isOpen={showConfirmationModal} onClose={onClose} onConfirm={onModalConfirm} title={props.title} />
    </>
  );
};
