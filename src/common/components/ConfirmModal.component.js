    ...
    <Overlay isVisible={props.isOpen} onBackdropPress={props.onClose} height={screenHeight / 3}>
      <>
        ...
        <View style={confirmModalStyle.titleView}>
          <Text style={confirmModalStyle.titleText}>Do you want to leave?</Text>
          <Text>{props.title}</Text>
        </View>
        <View style={confirmModalStyle.actionsView}>
          <View style={confirmModalStyle.actionsViewInner}>
            <Button title="Cancel" type="outline" containerStyle={confirmModalStyle.button} onPress={props.onClose} />
            <Button title="Ok" containerStyle={confirmModalStyle.button} onPress={props.onConfirm} />
          </View>
        </View>
      </>
    </Overlay>
