...
const dropdownSettings = {
  language: [{ value: "en" }, { value: "pl" }],
  difficultyLevel: [{ value: "easy" }, { value: "normal" }, { value: "medium" }, { value: "hard" }],
  type: [{ value: "public" }, { value: "private" }]
};
...
class BasicInfoCourseStageComponent extends Component {
  ...
  //events
  _onChange(e, name) {
    //dynamic change state // name === stateName
    this.setState({
    ...
    return (
      <View style={basicInfoStyle.view}>
        ...
        <View style={basicInfoStyle.submitButtonView}>
          <Button title="Next" loading={clicked ? true : false} containerStyle={basicInfoStyle.submitButton} onPress={this._onSubmit} />
        </View>
      </View>
    );
  }
