...
import AnswerOverlayComponent from "./AnswerOverlay.component";
...
class AnswerComponent extends Component {
  ...
  onPress() {
    ...
    setTimeout(() => {
      this.props.onAnswerPress(this.props.valid);
    }, 1000);
  }
  ...
  render() {
    ...
    return (
      <View style={answerStyle.view}>
        ...
        <TouchableOpacity activeOpacity={0.7} disabled={answered} onPress={() => this.onPress()}>
          <ImageBackground source={{ uri: image }} style={answerStyle.imageBackground} imageStyle={answerStyle.imageStyle}>
